...
ActiveRecord::Schema.define(version: 20171219190713) do
  ...
  create_table "calendars", force: :cascade do |t|
    ...
    t.index ["game_id"], name: "index_calendars_on_game_id"
  end
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.integer "roster_spot", default: 1
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "is_rink", default: false
    t.string "position"
    t.string "pin"
