  ...
  private
    ...
    def create_notification
      if self.conversation.sender_id == self.user_id
        ...
        Notification.create(content: "New message #{sender.fullname}", user_id: self.conversation.recipient_id)
      else
        sender = User.find(self.conversation.recipient_id)
        Notification.create(content: "New message #{sender.fullname}", user_id: self.conversation.sender_id)
      end
